export function buildSectionHeadingTextImagesBlock(editor: any, category: string) {
	...
	const block = {
		...
		activate: true,
		content: JSON.parse(
			`[{"classes":["w-full","max-w-screen-desktop","mx-auto"],"attributes":{"id":"iwuy8"},"_undoexc":["status","open"]},{"classes":["w-full","max-w-screen-desktop","container","mx-auto"],"attributes":{"id":"ix4qe"},"_undoexc":["status","open"],"components":[{"classes":["w-full","cell","py-px-48"],"attributes":{"id":"i1q2h"},"_undoexc":["status","open"],"components":[{"classes":["w-full","max-w-screen-desktop","container","mx-auto"],"attributes":{"id":"izgpc"},"_undoexc":["status","open"],"components":[{"classes":["w-full","cell"],"_undoexc":["status","open"],"components":[{"type":"text","classes":["m-0","text-center","text-px-32","tablet:text-px-48","font-secondary"],"attributes":{"id":"i32t"},"_undoexc":["status","open"],"components":[{"type":"textnode","content":"Heading","_undoexc":["status","open"]}]}]}]},{"classes":["w-full","max-w-screen-desktop","container","mx-auto","py-px-48"],"attributes":{"id":"ic8g3"},"_undoexc":["status","open"],"components":[{"classes":["w-full","cell"],"attributes":{"id":"isovp"},"_undoexc":["status","open"],"components":[{"tagName":"p","type":"text","classes":["font-primary","m-0","text-center"],"attributes":{"id":"iv1cw"},"_undoexc":["status","open"],"components":[{"type":"textnode","content":"Insert your text here","_undoexc":["status","open"]}]}]}]},{"classes":["w-full","max-w-screen-desktop","container","mx-auto","flex","flex-col","tablet:flex-row","py-px-16","gap-px-40"],"attributes":{"id":"iq8qw"},"_undoexc":["status","open"],"components":[{"classes":["w-full","tablet:w-6/12","cell"],"_undoexc":["status","open"],"components":[{"type":"image","resizable":{"ratioDefault":1},"classes":["aspect-square","w-full","rounded-px-16"],"_undoexc":["status","open"]}]},{"classes":["w-full","tablet:w-6/12","cell"],"attributes":{"id":"iwxh-3"},"_undoexc":["status","open"],"components":[{"type":"image","resizable":{"ratioDefault":1},"classes":["aspect-square","w-full","rounded-px-16"],"_undoexc":["status","open"]}]}]},{"classes":["w-full","max-w-screen-desktop","container","mx-auto","flex","flex-col","tablet:flex-row","py-px-16","gap-px-40"],"attributes":{"id":"iwq1l"},"_undoexc":["status","open"],"components":[{"classes":["w-full","tablet:w-6/12","cell"],"_undoexc":["status","open"],"components":[{"type":"image","resizable":{"ratioDefault":1},"classes":["aspect-square","w-full","rounded-px-16"],"_undoexc":["status","open"]}]},{"classes":["w-full","tablet:w-6/12","cell"],"attributes":{"id":"isbgj"},"_undoexc":["status","open"],"components":[{"type":"image","resizable":{"ratioDefault":1},"classes":["aspect-square","w-full","rounded-px-16"],"_undoexc":["status","open"]}]}]}]}]}]`
		),
	}
